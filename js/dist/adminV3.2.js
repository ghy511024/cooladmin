...
window.zform = (function () {
    ...
    var zform = {
        init: function () {
            ...
            //===========save 获取数据=======
            $(document).on("click", ".z-form .close,.z-form .save", function () {
                zform.save();
            })
        }, bindEvent: function () {
        ...
        cform: function (data) {
            ...
            for (var key in data) {
                ...
                if (item != null) {
                    ...
                    console.log(type)
                    if (type == "text") {
                        var item = _this._getText(data[key], type);
                        $(panel).append(item);
                    }
                    else if (type == "radio") {
                        var item = _this._getRadio(data[key], type);
                        $(panel).append(item);
                    }
                    else if (type == "checkbox") {
                        var item = _this._getCheckbox(data[key], type);
                        $(panel).append(item);
                    }
                    else if (type == "textarea") {
                        var item = _this._getTextArea(data[key], type);
                        $(panel).append(item);
                    }
                    else if (type == "dynlist") {
                        var item = _this._getDynlist(data[key], type);
                        $(panel).append(item);
                    }
