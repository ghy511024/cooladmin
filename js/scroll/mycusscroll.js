    ...
    var b = {
        init: function (e) {
            ...
            return this.each(function () {
                ...
                m.wrapInner("<div class='mCustomScrollBox mCS-" + e.theme + "' id='mCSB_" + c(document).data("mCustomScrollbar-index") + "' style='position:absolute; height:100%; overflow:hidden; width:100%;' />").addClass("mCustomScrollbar _mCS_" + c(document).data("mCustomScrollbar-index"));
        ...
        update: function () {
            ...
            var y = k.children(".mCSB_scrollTools"),
                    o = y.children(".mCSB_draggerContainer"), //����panel
            ...
            if (k.data("mouseWheel")) {
                if (!k.data("bindEvent_mousewheel")) {
                    h.bind("mousewheel", function (H, J) {
                        ...
                        //I为总高度 y 为滚动高度
                        if ((I == y)) {
                            //                            RoomList.loadingUser("userlist");
                        }
                        if (window.Chat) {
                            Chat.scro = (y - I) > 35 ? true : false;
                        }
